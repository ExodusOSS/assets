...
jest.mock('./../simulation/simulateTransactions', () => ({
  __esModule: true,
...
} = await import('./../simulation/simulateTransactions')

const { createSimulateTransactions } = await import('./../createSimulateTransactions')
...
describe('createSimulateTransaction', () => {
  ...
  describe('simulateTransaction', () => {
    ...
    it('should return the simulation result', async () => {
      ...
      expectedResult.advancedDetails = [
        {
          title: 'Unknown',
          instructions: [
            {
