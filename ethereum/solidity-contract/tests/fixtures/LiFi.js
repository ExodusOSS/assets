export const LiFiAbi = [
  { inputs: [], name: 'CannotAuthoriseSelf', type: 'error' },
  ...
  { inputs: [], name: 'CannotBridgeToSameNetwork', type: 'error' },
  ...
  { inputs: [], name: 'QuoteTimeout', type: 'error' },
  ...
  },
  {
    inputs: [
      ...
      {
        components: [
          { internalType: 'uint64', name: 'relayerFeePct', type: 'uint64' },
  ...
  },
  {
    inputs: [],
    name: 'allBridge',
    outputs: [{ internalType: 'contract IAllBridge', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: 'bytes32', name: 'receiveToken', type: 'bytes32' },
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: 'uint256', name: 'slippageTol', type: 'uint256' },
          { internalType: 'address', name: 'delegate', type: 'address' },
          { internalType: 'uint32', name: 'destChainDomainId', type: 'uint32' },
        ],
  ...
  { inputs: [], name: 'RecoveryAddressCannotBeZero', type: 'error' },
  { inputs: [], name: 'SymbolDoesNotExist', type: 'error' },
  ...
  },
  {
    inputs: [
      ...
      {
        components: [
          { internalType: 'uint32', name: 'maxSlippage', type: 'uint32' },
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: 'bytes', name: 'callData', type: 'bytes' },
          { internalType: 'uint256', name: 'messageBusFee', type: 'uint256' },
          {
  ...
  { inputs: [], name: 'InvalidSendingToken', type: 'error' },
  {
    inputs: [
      {
        components: [
      ...
      {
        components: [{ internalType: 'uint32', name: 'dstDomain', type: 'uint32' }],
        ...
        components: [
          ...
          { internalType: 'uint32', name: 'referralCode', type: 'uint32' },
          {
            components: [
              ...
              { internalType: 'bytes', name: 'fallbackAddress', type: 'bytes' },
  ...
  },
  {
    inputs: [
      ...
      {
        components: [{ internalType: 'string', name: 'destinationAddress', type: 'string' }],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address[]', name: 'tokensToApprove', type: 'address[]' },
    ],
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'address', name: 'anyTokenAddress', type: 'address' },
        ],
        indexed: false,
  ...
  { inputs: [], name: 'InvalidFallbackAddress', type: 'error' },
  {
  ...
  },
  {
    inputs: [
      ...
      {
        components: [
          { internalType: 'address', name: 'assetIdOnL2', type: 'address' },
          { internalType: 'uint32', name: 'l2Gas', type: 'uint32' },
          { internalType: 'bool', name: 'isSynthetix', type: 'bool' },
        ],
  ...
  },
  {
    inputs: [],
    name: 'squidRouter',
    outputs: [{ internalType: 'contract ISquidRouter', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: 'bool', name: 'forecallEnabled', type: 'bool' },
        ],
  ...
  },
  {
    inputs: [],
    name: 'synapseRouter',
    outputs: [{ internalType: 'contract ISynapseRouter', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_lifiChainId', type: 'uint256' },
      { internalType: 'uint16', name: '_wormholeChainId', type: 'uint16' },
    ],
  ...
  { inputs: [], name: 'AddressOutOfBounds', type: 'error' },
  { inputs: [], name: 'UintOutOfBounds', type: 'error' },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'address', name: 'dex', type: 'address' },
      {
        indexed: false,
        internalType: 'address',
        name: 'fromAssetId',
